...
* (2020년 4분기 서비스 예정) 도로 위험도 및 운전자 평가 점수 제공
* (비공개 서비스 - 관리자 문의) 예측 교통 정보 제공
* (비공개 서비스 - 관리자 문의) 차선 단위 교통 정보 제공

실시간 교통 정보 등 제공
--------------------------
SKT T Map 과 연동하여 1800만 운전자의 이동 정보 데이터를 바탕으로 실시간 교통 정보를 제공합니다. RUUT가 제공하는 편리한 API 인터페이스를 통해 원하는 지역의 실시간 교통 정보를 쉽게 얻을 수 있습니다.
...
예측 교통 정보 (FTI, 비공개 서비스)
''''''''''''''''''''''''''
머신 러닝 기반으로 학습된 데이터를 토대로 명시된 시간에서 도로 세그먼트의 미래 교통 정보를 제공합니다. 해당 서비스는 비공개 서비스이며 별도의 계약을 통하여 제공합니다. 해당 서비스에 대한 상세한 정보는 관리자를 통해 문의하시기 바랍니다. 
...
RNA (Road Network Analysis, 2020년 4분기 서비스 )
--------------------------
...
--------------------------
RUUT 는 도로 특정 영역에 대하여 차선 단위 교통 정보를 제공합니다. 해당 서비스는 비공개 서비스이며 별도의 계약을 통하여 제공합니다. 해당 서비스에 대한 상세한 정보는 관리자를 통해 문의하시기 바랍니다. 
